...
from transport_diagnostics import (CategoryCounterFile, TransportDiagnostics,
            ...
            if not self._stop_requested.is_set():
                ...
                if client is not None:
                    ...
                    self.progress_scheduler = self._progress_scheduler_factory(
                        ...
                        self.largeitem_model, self.setup_controller
                    )
                    ...
                    if configure is not None:
                        configure(self.progress_scheduler.handle_run,
                                  ...
                                  self.now_playing_model.secondary_command_from_event)
