...
class TransportRouter:
    def __init__(
        ...
        self.diagnostics = diagnostics or TransportDiagnostics()
        self.client = client or BridgeClient(diagnostics=self.diagnostics)
        ...
        while True:
            ...
            try:
                ...
                if self._stop_event.is_set():
                    ...
                    self.diagnostics.result(self.last_result.status)
                    continue
                try:
