...
COMMAND_REQUEST_TIMEOUT_SECONDS = 10.0
...
class BridgeClient:
    def __init__(
        ...
        self._opener = opener
        self._diagnostics = diagnostics or TransportDiagnostics()
    ...
    def _execute(self, command: str, cancelled: Callable[[], bool] | None = None) -> BridgeResult:
        ...
        self._diagnostics.command_post_attempt()
        try:
            with self._opener(request, timeout=COMMAND_REQUEST_TIMEOUT_SECONDS) as response:
